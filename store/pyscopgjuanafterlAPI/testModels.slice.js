...
export const api_v1_testmodel_list = createAsyncThunk("testModels/api_v1_testmodel_list", async payload => {
  const response = await apiService.api_v1_testmodel_list(payload);
  return response.data;
});
export const api_v1_testmodel_create = createAsyncThunk("testModels/api_v1_testmodel_create", async payload => {
  const response = await apiService.api_v1_testmodel_create(payload);
  return response.data;
});
export const api_v1_testmodel_retrieve = createAsyncThunk("testModels/api_v1_testmodel_retrieve", async payload => {
  const response = await apiService.api_v1_testmodel_retrieve(payload);
  return response.data;
});
export const api_v1_testmodel_update = createAsyncThunk("testModels/api_v1_testmodel_update", async payload => {
  const response = await apiService.api_v1_testmodel_update(payload);
  return response.data;
});
export const api_v1_testmodel_partial_update = createAsyncThunk("testModels/api_v1_testmodel_partial_update", async payload => {
  const response = await apiService.api_v1_testmodel_partial_update(payload);
  return response.data;
});
export const api_v1_testmodel_destroy = createAsyncThunk("testModels/api_v1_testmodel_destroy", async payload => {
...
const testModelsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_testmodel_list.pending, (state, action) => {
