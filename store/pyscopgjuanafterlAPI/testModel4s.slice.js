...
export const api_v1_testmodel4_list = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_list",
  async payload => {
    const response = await apiService.api_v1_testmodel4_list(payload)
    return response.data
  }
)
export const api_v1_testmodel4_create = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_create",
  async payload => {
    const response = await apiService.api_v1_testmodel4_create(payload)
    return response.data
  }
)
export const api_v1_testmodel4_retrieve = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_retrieve",
  async payload => {
    const response = await apiService.api_v1_testmodel4_retrieve(payload)
    return response.data
  }
)
export const api_v1_testmodel4_update = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_update",
  async payload => {
    const response = await apiService.api_v1_testmodel4_update(payload)
    return response.data
  }
)
export const api_v1_testmodel4_partial_update = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_partial_update",
  async payload => {
    const response = await apiService.api_v1_testmodel4_partial_update(payload)
    return response.data
  }
)
export const api_v1_testmodel4_destroy = createAsyncThunk(
  "testModel4s/api_v1_testmodel4_destroy",
  async payload => {
...
const testModel4sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_testmodel4_list.pending, (state, action) => {
