...
export const api_v1_juan_list = createAsyncThunk("juans/api_v1_juan_list", async payload => {
  const response = await apiService.api_v1_juan_list(payload);
  return response.data;
});
export const api_v1_juan_create = createAsyncThunk("juans/api_v1_juan_create", async payload => {
  const response = await apiService.api_v1_juan_create(payload);
  return response.data;
});
export const api_v1_juan_retrieve = createAsyncThunk("juans/api_v1_juan_retrieve", async payload => {
  const response = await apiService.api_v1_juan_retrieve(payload);
  return response.data;
});
export const api_v1_juan_update = createAsyncThunk("juans/api_v1_juan_update", async payload => {
  const response = await apiService.api_v1_juan_update(payload);
  return response.data;
});
export const api_v1_juan_partial_update = createAsyncThunk("juans/api_v1_juan_partial_update", async payload => {
  const response = await apiService.api_v1_juan_partial_update(payload);
  return response.data;
});
export const api_v1_juan_destroy = createAsyncThunk("juans/api_v1_juan_destroy", async payload => {
...
const juansSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_juan_list.pending, (state, action) => {
