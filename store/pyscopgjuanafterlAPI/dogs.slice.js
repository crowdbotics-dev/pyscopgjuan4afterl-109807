...
export const api_v1_dog_list = createAsyncThunk("dogs/api_v1_dog_list", async payload => {
  const response = await apiService.api_v1_dog_list(payload);
  return response.data;
});
export const api_v1_dog_create = createAsyncThunk("dogs/api_v1_dog_create", async payload => {
  const response = await apiService.api_v1_dog_create(payload);
  return response.data;
});
export const api_v1_dog_retrieve = createAsyncThunk("dogs/api_v1_dog_retrieve", async payload => {
  const response = await apiService.api_v1_dog_retrieve(payload);
  return response.data;
});
export const api_v1_dog_update = createAsyncThunk("dogs/api_v1_dog_update", async payload => {
  const response = await apiService.api_v1_dog_update(payload);
  return response.data;
});
export const api_v1_dog_partial_update = createAsyncThunk("dogs/api_v1_dog_partial_update", async payload => {
  const response = await apiService.api_v1_dog_partial_update(payload);
  return response.data;
});
export const api_v1_dog_destroy = createAsyncThunk("dogs/api_v1_dog_destroy", async payload => {
...
const dogsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_dog_list.pending, (state, action) => {
