...
export const api_v1_testmodel2_list = createAsyncThunk("testModel2s/api_v1_testmodel2_list", async payload => {
  const response = await apiService.api_v1_testmodel2_list(payload);
  return response.data;
});
export const api_v1_testmodel2_create = createAsyncThunk("testModel2s/api_v1_testmodel2_create", async payload => {
  const response = await apiService.api_v1_testmodel2_create(payload);
  return response.data;
});
export const api_v1_testmodel2_retrieve = createAsyncThunk("testModel2s/api_v1_testmodel2_retrieve", async payload => {
  const response = await apiService.api_v1_testmodel2_retrieve(payload);
  return response.data;
});
export const api_v1_testmodel2_update = createAsyncThunk("testModel2s/api_v1_testmodel2_update", async payload => {
  const response = await apiService.api_v1_testmodel2_update(payload);
  return response.data;
});
export const api_v1_testmodel2_partial_update = createAsyncThunk("testModel2s/api_v1_testmodel2_partial_update", async payload => {
  const response = await apiService.api_v1_testmodel2_partial_update(payload);
  return response.data;
});
export const api_v1_testmodel2_destroy = createAsyncThunk("testModel2s/api_v1_testmodel2_destroy", async payload => {
...
const testModel2sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_testmodel2_list.pending, (state, action) => {
