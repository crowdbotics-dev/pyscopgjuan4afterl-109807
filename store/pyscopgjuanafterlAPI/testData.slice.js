...
export const api_v1_testdata_list = createAsyncThunk(
  "testData/api_v1_testdata_list",
  async payload => {
    const response = await apiService.api_v1_testdata_list(payload)
    return response.data
  }
)
export const api_v1_testdata_create = createAsyncThunk(
  "testData/api_v1_testdata_create",
  async payload => {
    const response = await apiService.api_v1_testdata_create(payload)
    return response.data
  }
)
export const api_v1_testdata_retrieve = createAsyncThunk(
  "testData/api_v1_testdata_retrieve",
  async payload => {
    const response = await apiService.api_v1_testdata_retrieve(payload)
    return response.data
  }
)
export const api_v1_testdata_update = createAsyncThunk(
  "testData/api_v1_testdata_update",
  async payload => {
    const response = await apiService.api_v1_testdata_update(payload)
    return response.data
  }
)
export const api_v1_testdata_partial_update = createAsyncThunk(
  "testData/api_v1_testdata_partial_update",
  async payload => {
    const response = await apiService.api_v1_testdata_partial_update(payload)
    return response.data
  }
)
export const api_v1_testdata_destroy = createAsyncThunk(
  "testData/api_v1_testdata_destroy",
  async payload => {
...
const testDataSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_testdata_list.pending, (state, action) => {
