...
export const api_v1_testmodel3_list = createAsyncThunk("testModel3s/api_v1_testmodel3_list", async payload => {
  const response = await apiService.api_v1_testmodel3_list(payload);
  return response.data;
});
export const api_v1_testmodel3_create = createAsyncThunk("testModel3s/api_v1_testmodel3_create", async payload => {
  const response = await apiService.api_v1_testmodel3_create(payload);
  return response.data;
});
export const api_v1_testmodel3_retrieve = createAsyncThunk("testModel3s/api_v1_testmodel3_retrieve", async payload => {
  const response = await apiService.api_v1_testmodel3_retrieve(payload);
  return response.data;
});
export const api_v1_testmodel3_update = createAsyncThunk("testModel3s/api_v1_testmodel3_update", async payload => {
  const response = await apiService.api_v1_testmodel3_update(payload);
  return response.data;
});
export const api_v1_testmodel3_partial_update = createAsyncThunk("testModel3s/api_v1_testmodel3_partial_update", async payload => {
  const response = await apiService.api_v1_testmodel3_partial_update(payload);
  return response.data;
});
export const api_v1_testmodel3_destroy = createAsyncThunk("testModel3s/api_v1_testmodel3_destroy", async payload => {
...
const testModel3sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_testmodel3_list.pending, (state, action) => {
